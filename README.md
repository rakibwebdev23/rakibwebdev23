...
## 📊 GitHub Stats
<div style="display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 1200px; margin: 0 auto; gap: 20px; padding: 10px;">

  <!-- First Row with Row-wise Flex -->
  <div style="display: flex; flex-wrap: wrap; flex-direction: row; width: 100%; gap: 10px;">
    <img 
      ...
      style="flex: 1 1 48%; height: auto; object-fit: contain; max-width: 100%;" 
    />
    <img 

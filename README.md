...
- MERN Stack Developer creating scalable & high-performance applications  
- Specialized in **React, Next.js, TypeScript, Node.js, MongoDB**  
- Passionate about clean code, UI/UX, design systems & modern frontend architecture  
- Currently learning backend architecture & DevOps (CI/CD, Deployment)  
...
- Improved app performance with **lazy-loading**, **code-splitting**, and **Next.js optimization**  
- Implemented reusable design systems & component-driven frontend architecture  
- Integrated REST APIs & collaborated with backend teams  
- Deploying applications using **Vercel** & **Firebase**  
- Active in code reviews, sprint planning, feature releases  
...
<p align="center">
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=rakibwebdev23&theme=radical" width="90%" />
</p>
